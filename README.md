...
Amended 8Sep2022 to split the Book & Page column.
...
Table is named **ScrapedData3**
   ...
   - **ScrapedData4-30Aug2022.csv** 
Output of scrapingvgsi.py, collected from full list of PIDs.
(See ScrapgingVGSI for details.)
Requires running in segments because Vision seems to reject repeated queries.
Table is named **ScrapedData4**
